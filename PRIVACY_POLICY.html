# Privacy Policy for TaskSprint

**Last Updated: November 4, 2025**

## Introduction

TaskSprint ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, store, and safeguard your information when you use our mobile application.

**Important: TaskSprint currently operates as a local-only personal planning app. All your data is stored exclusively on your device, and we do not collect, transmit, or share your data with any servers or third parties.**
...
TaskSprint may request the following permissions to enhance your experience. **All permissions are optional and the app works without them.**
...
- Syncing events between TaskSprint and your device calendar
...
**Since TaskSprint stores all data locally on your device, we do not "use" your information in the traditional sense. Your data never leaves your device.**

Your information is processed locally on your device to:
- Provide and maintain TaskSprint app functionality
...
TaskSprint stores ALL data exclusively on your device using:
...
**TaskSprint does NOT share any data because all data is stored locally on your device.**
...
When you "invite team members" to events in TaskSprint v1.0:
...
**For real team collaboration**, a future version (TaskSprint Pro) will require a backend server and will be accompanied by an updated privacy policy with explicit consent.
...
**TaskSprint v1.0 does NOT use any third-party services.**
...
TaskSprint is built using Expo, but we do NOT use EAS Updates or EAS telemetry in production:
...
When TaskSprint Pro is released with cloud sync and collaboration features, we will:
...
**To delete all data**:
- Uninstall TaskSprint from your device
...
**With TaskSprint's local-only storage, you have complete control over your data.**
...
- **Future Permissions** (Calendar, Camera, Photos, Location):
  - Grant or revoke in iOS Settings → TaskSprint
...
TaskSprint is rated 4+ and suitable for all ages. Since all data is stored locally on the device and no personal information is collected or transmitted:
...
If you have concerns about your child's use of TaskSprint, you can:
...
**TaskSprint's local-only architecture provides strong privacy protection by design.**

### Security Measures in Place

1. **Device-Level Security**:
   - Your data is protected by your device's passcode or biometric authentication
   - iOS and Android sandbox protections prevent other apps from accessing TaskSprint data
...
- **Physical device access**: If someone has access to your unlocked device, they can access TaskSprint
- **Device backups**: iOS device backups may include TaskSprint data
...
**TaskSprint's local-only architecture means CCPA requirements largely do not apply, but we provide this information for transparency.**
...
**TaskSprint's local-only architecture means GDPR requirements largely do not apply, but we provide this information for transparency.**
...
**TaskSprint does NOT transfer data internationally because all data is stored locally on your device.**
...
When TaskSprint Pro is released with cloud sync:
...
- You'll have the choice to upgrade or keep using TaskSprint v1.0

### Your Continued Use
By continuing to use TaskSprint after changes are posted, you accept the updated Privacy Policy.

## Contact Us

If you have questions, concerns, or requests regarding this Privacy Policy:

**Email**: privacy@TaskSprint.app
**Support**: support@TaskSprint.app
**Developer**: Vibecode Inc.

**Important Note**: Since TaskSprint v1.0 stores all data locally on your device:
...
By using TaskSprint, you acknowledge that you have read and understood this Privacy Policy.
...
**If you do not agree with this Privacy Policy, please do not use TaskSprint.**

---

## Summary: TaskSprint v1.0 Privacy in Plain English

✅ **What TaskSprint Does**:
...
This is a **personal planning app** designed for individual use with complete privacy. When TaskSprint Pro adds real collaboration and cloud features, we'll update this policy and ask for your explicit consent.
